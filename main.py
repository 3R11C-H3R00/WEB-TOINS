...
def login():
    ...
    if request.method == 'POST':
        ...
        if username == 'ERIIC-TRICKER' and password == '3R11C_XD':
            ...
            return redirect('https://l44d.onrender.com')
        else:
...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            height: 100vh;
            background: url('https://i.ibb.co/0GW723F/8bf970cd8da203fd28a7445b2d964ecd.jpg') no-repeat center center fixed;
...
<body>
    ...
    <div class="container">
        ...
        <div class="admin-contact">
            <p>Need help? <a href="https://wa.me/+923417885339" target="_blank">Contact Admin</a></p>
        </div>
    </div>
</body>
</html>
